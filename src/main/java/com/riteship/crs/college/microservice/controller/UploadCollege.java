...
public class UploadCollege extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RiteShipCollegeDBOperationsBean dbOperationsBean = new RiteShipCollegeDBOperationsBean();
		String emp_id = "0";
		if((request.getParameter("act")).equals("Save"))
		{
			...
			{
				dbOperationsBean.getDatabaseOperationsBean().saveCollege(results);
			...
			{
				results.put("college_id",request.getParameter("college_id"));
				dbOperationsBean.getDatabaseOperationsBean().updateCollege(results);
